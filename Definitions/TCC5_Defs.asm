...
; Organization:
;     1.  TCC5 Base Address and Register Offsets
;     2.  TCC5 Register Addresses
;     3.  TC5  Bit and Value Definitions
;     4.  TCC5 Interrupt Vectors
...
; TCC5 Base Address and Register Offsets
; (Ref 1, Sect. 33 and Ref 2, Sects. 13.14, 13.16)
; -----------------------------------------------------------------------------
; -----------------------------------------------------------------------------
.equ TCC5_base               = 0x0840       ; 16-bit Timer/Counter With PWM
...
; TCC5 Register Addresses
; -----------------------------------------------------------------------------
; -----------------------------------------------------------------------------
.equ TCC5_CTRLA              = 0x0840        ; Control Register A
.equ TCC5_CTRLB              = 0x0841        ; Control Register B
.equ TCC5_CTRLC              = 0x0842        ; Control Register C
.equ TCC5_CTRLD              = 0x0843        ; Control Register D
.equ TCC5_CTRLE              = 0x0844        ; Control Register E
.equ TCC5_CTRLF              = 0x0845        ; Control Register F
.equ TCC5_INTCTRLA           = 0x0846        ; Interrupt Control Register A
.equ TCC5_INTCTRLB           = 0x0847        ; Interrupt Control Register B
.equ TCC5_CTRLGCLR           = 0x0848        ; Control Register G Clear
.equ TCC5_CTRLGSET           = 0x0849        ; Control Register G Set
.equ TCC5_CTRLHCLR           = 0x084A        ; Control Register H Clear
.equ TCC5_CTRLHSET           = 0x084B        ; Control Register H Set
.equ TCC5_INTFLAGS           = 0x084C        ; Interrupt Flag Register
.equ TCC5_TEMP               = 0x084F        ; Temporary Register For 16-bit Access
.equ TCC5_CNT                = 0x0860        ; Count
.equ TCC5_PER                = 0x0866        ; Period
.equ TCC5_CCA                = 0x0868        ; Compare or Capture A
.equ TCC5_CCB                = 0x086A        ; Compare or Capture B
.equ TCC5_PERBUF             = 0x0876        ; Period Buffer
.equ TCC5_CCABUF             = 0x0878        ; Compare Or Capture A Buffer
.equ TCC5_CCBBUF             = 0x087A        ; Compare Or Capture B Buffer
...
; TCC5_CTRLA Register  (Ref 2, Sect. 13.12.1)
; -----------------------------------------------------------------------------
; Bit Postions
...
; TCC5_CTRLB Register  (Ref 2, Sect. 13.12.2)
; -----------------------------------------------------------------------------
...
; TCC5_CTRLC Register (Normal 16-bit Mode)  (Ref 2, Sect. 13.12.3)
; -----------------------------------------------------------------------------
; Bit Positions
...
; TCC5_CTRLC Register (Byte Mode)  (Ref 2, Sect. 13.13.3)
; -----------------------------------------------------------------------------
; Bit Positions
...
; TCC5_CTRLD Register  (Ref 2, Sect. 13.12.4)
; -----------------------------------------------------------------------------
; Bit Positions
...
; TCC5_CTRLE Register (Normal 16-bit Mode)  (Ref 2, Sect. 13.12.5)
; -----------------------------------------------------------------------------
...
; TCC5_CTRLE Register (Byte Mode)  (Ref 2, Sect. 13.13.5)
; -----------------------------------------------------------------------------
...
; TCC5_CTRLF Register (Byte Mode)  (Ref 2, Sect. 13.13.6)
; -----------------------------------------------------------------------------
...
; TCC5_INTCTRLA Register  (Ref 2, Sect. 13.12.6)
; -----------------------------------------------------------------------------
...
; TCC5_INTCTRLB Register (Normal 16-bit Mode)  (Ref 2, Sect. 13.12.7)
; -----------------------------------------------------------------------------
...
; TCC5_INTCTRLB Register (Byte Mode)  (Ref 2, Sect. 13.13.8)
; -----------------------------------------------------------------------------
...
; TCC5_CTRLGCLR Register  (Ref 2, Sect. 13.12.8)
; TCC5_CTRLGSET Register
; -----------------------------------------------------------------------------
; Bit Positions
;*******************************************************************
;!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
; TCC5_CTRLHCLR Register (Normal 16-bit Mode)  (Ref 2, Sect. 13.12.9)
; TCC5_CTRLHSET Register
; -----------------------------------------------------------------------------
; Bit Positions
...
; TCC5_CTRLHCLR Register (Byte Mode)  (Ref 2, Sect. 13.13.10)
; TCC5_CTRLHSET Register
; -----------------------------------------------------------------------------
; Bit Positions
...
; TCC5_INTFLAGS Register (Normal 16-bit Mode)  (Ref 2, Sect. 13.12.10)
; -----------------------------------------------------------------------------
; Bit Positions
...
; TCC5_INTFLAGS Register (Byte Mode)  (Ref 2, Sect. 13.13.11)
; -----------------------------------------------------------------------------
; Bit Positions
...
; -----------------------------------------------------------------------------
; -----------------------------------------------------------------------------
.equ TCC5_OVF_vect              = 0x0024    ; Overflow
.equ TCC5_ERR_vect              = 0x0026    ; Error
.equ TCC5_CCA_vect              = 0x0028    ; Channel A Compare or Capture
.equ TCC5_CCB_vect              = 0x002A    ; Channel B Compare or Capture
